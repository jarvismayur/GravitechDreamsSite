    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="sidebar-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li>
            <a href=""  data-toggle="modal" data-target="#Store" class="nav-link">Store</a>
          </li>
          <li class="nav-item ">
    ...
    <div class="col-lg-6">
      ...
      <form class="form" action="Work.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group mx-auto">
          ...
          <textarea name="description_1"  class="form-control" rows="8" cols="80"></textarea>
        </div>
        <div class="form-group mx-auto">
          <label for="description" class="h4">Description 2</label>
          <textarea name="description_2"  class="form-control" rows="8" cols="80"></textarea>
        </div>
        <div class="form-group mx-auto">
          <label for="description" class="h4">Description 3</label>
          <textarea name="description_3"  class="form-control" rows="8" cols="80"></textarea>
        </div>
        <div class="form-group mx-auto">
          <label for="description" class="h4">Description 4</label>
          <textarea name="description_4"  class="form-control" rows="8" cols="80"></textarea>
        </div>
        <div class="form-group mx-auto">
          <label for="description" class="h4">Description 5</label>
          <textarea name="description_5"  class="form-control" rows="8" cols="80"></textarea>
        </div>
        <div class="form-group mx-auto">
          <label for="title" class="h4">Image</label>
          <input type="file" class="form-control" name="file_1" value=""  required>
        </div>
        <div class="form-group mx-auto">
          <label for="title" class="h4">Image 2</label>
          <input type="file" class="form-control" name="file_2" value=""  required>
        </div>
        <div class="form-group mx-auto">
