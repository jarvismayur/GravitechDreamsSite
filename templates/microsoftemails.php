...
<head>
  <meta charset="utf-8">
  <title> Office 365 Mails | Gravitech Dreams</title>
  ...
  <header id="header">
    ...
    <div class="container">
      ...
      <div class="logo float-left d-inline-flex">
        ...
        <h2 class="text-light"><a href="index.php" class="scrollto"><img src="img/logo.png" alt="" class="img-fluid">&emsp;<span>GD Office 365 Mails </span></a></h2>
