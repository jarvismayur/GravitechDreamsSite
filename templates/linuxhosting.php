...
<head>
  <meta charset="utf-8">
  <title>Linux Hosting | Gravitech Dreams</title>
  ...
  <header id="header">
    ...
    <div class="container">
      ...
      <div class="logo float-left d-inline-flex">
        ...
        <h2 class="text-light"><a href="index.php" class="scrollto"><img src="img/logo.png" alt="" class="img-fluid">&emsp;<span>GD Linux Hosting </span></a></h2><sub class="mt-4 ml-4">Beta</sub>
